...
btn.addEventListener("click", () => {
    ...
    if (elements[1].value == "" || elements[1].value == null) {
        ...
        el10.appendChild(ele9);

        var counter = el10.getElementsByTagName("tr");

        let x1 = document.getElementById("count");
